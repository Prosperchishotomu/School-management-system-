      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-line-border/30 pb-5 gap-4">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2.5 bg-teal-primary hover:bg-teal-dark text-paper font-sans font-semibold text-xs rounded-xl shadow-md transition-all cursor-pointer"
          >
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <h4 className="text-sm font-sans font-bold text-ink">{item.title || 'Notification'}</h4>
                    {!item.is_read && (
